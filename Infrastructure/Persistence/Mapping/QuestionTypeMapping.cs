...
public class QuestionTypeMapping : EntityTypeConfiguration<QuestionType>
{
    ...
    public override void Configure(EntityTypeBuilder<QuestionType> entity)
    {
        #region Configures
        entity.ToTable(nameof(QuestionType), "public");

        entity.HasKey(qt => qt.Id);

        entity.Property(qt => qt.Name).IsRequired();

        entity.Property(qt => qt.DisplayedTitle);
